...
/**
 * Deterministic score table driven by an LCG, so server and client render the
 * exact same rows for a given seed and no hydration mismatch can occur.
 */
export const seededScores = (seed: number, count = 12): ScoreRow[] => {
  let s = seed;
