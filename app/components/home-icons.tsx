export const FloatingSilhouettes = () => {
  return (
...
export const FeatureIcon = ({ kind }: FeatureIconProps) => {
...
interface HighlightIconProps {
  kind: HighlightIconKind;
}

export const HighlightIcon = ({ kind }: HighlightIconProps) => {
  const C = 'currentColor';
