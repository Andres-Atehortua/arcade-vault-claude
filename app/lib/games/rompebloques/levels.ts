/**
 * Rompebloques — level layouts.
 *
 * Typed port of references/started-games/04-arkanoid/levels.js: 5 levels, each
 * a block layout (in a 10-column × 6-row grid) plus a ball speed multiplier
 * that ramps up level over level.
 */

import type { BlockColor } from './spritesheet';
